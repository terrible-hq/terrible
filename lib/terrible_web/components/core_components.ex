defmodule TerribleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TerribleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TerribleWeb.Gettext, "errors", msg, opts)
    end
  end
